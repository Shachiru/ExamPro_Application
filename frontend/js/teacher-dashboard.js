...
$(document).ready(function() {
    ...
    $('.sidebar-toggle').click(function() {
        ...
        $('.menu-text').toggleClass('opacity-0');
    });
    ...
    $('#manageQuestions, #quickAddQuestion').click(function() {
    ...
    $('#logout, #logoutDropdown').click(function() {
...
function saveQuestion() {
    ...
    const url = questionId ? `${API_BASE_URL}/questions/${questionId}` : `${API_BASE_URL}/exams/${$('#examId').val()}/questions`;
